...
def act_choose(message):
    if message.text.split()[0].lower() == "нет":
        ...
        bot.register_next_step_handler(bot.send_message(message.chat.id, "Пришлите мне файл с вашей библиотекой"),
                                       get_doc)
...
def check_handler(message):
    ...
    bot.register_next_step_handler(bot.send_message(message.chat.id, "Пришлите файл с вашей библиотекой",
